	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>클라우드</span></a>
			</li>
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="filePage.jsp">파일 업로드</a> <a
							class="collapse-item" href="SharefontPage.jsp">폰트 공유 파일</a>
			...
			%>
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">클라우드</h1>
						<a href="#"
